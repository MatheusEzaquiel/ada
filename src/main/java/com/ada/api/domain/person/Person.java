...
public class Person {
	...
	public Person(UUID id, String login, String apelido, String nomeCompleto, String email, String telefone,
			String senha, String foto, boolean ativo, UserRole role) {
